...
public class ForegroundImageView extends ClipImageView {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final int gravity = custom.getInt(
                R.styleable.ForegroundImageView_fivForegroundGravity, Gravity.FILL);
        final boolean insidePadding = custom.getBoolean(
                R.styleable.ForegroundImageView_fivForegroundInsidePadding, true);
        custom.recycle();
        if (isForegroundEnable())
            ...
            mForegroundInfo.mInsidePadding = insidePadding;
            if (foreground != null)
